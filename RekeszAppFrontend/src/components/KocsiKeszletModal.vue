...
<template>
  <div class="overlay" @click.self="emit('close')">
    <div class="modal">
      ...
      <table v-else>
        <thead><tr><th>Zöldség</th><th>Rekesz</th><th class="num">Felvéve</th><th class="num">Eladva</th><th class="num">Maradt</th></tr></thead>
        <tbody>
          ...
          <tr v-if="!sorok.length"><td colspan="5" class="ures">Ma még nincs felvett áru.</td></tr>
        </tbody>
      </table>
    </div>
  </div>
...
.modal { background: #F7F3E8; border-radius: 10px; padding: 18px 20px; width: 100%; max-width: 520px; max-height: 80vh; overflow-y: auto; }
